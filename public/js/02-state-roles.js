/* ============================================================
   ...
   ============================================================ */
/* ===== STATUS CHIPS ===== */
const CHIP_STYLE={"On Time":"background:#FBEAE2;color:#047857","Submitted":"background:#FBEAE2;color:#047857","Pending":"background:#FFFBEB;color:#B45309","Late":"background:#FFF1F2;color:#BE123C","Pending Approval":"background:#FFF7ED;color:#C2410C","Rejected":"background:#FFF1F2;color:#9F1239","Active":"background:#FBEAE2;color:#047857","Inactive":"background:#F6F7F8;color:#9CA3AF","Approved":"background:#FBEAE2;color:#047857","Editing":"background:#EFF6FF;color:#1D4ED8","Upcoming":"background:#FAF5FF;color:#7E22CE","Draft":"background:#F6F7F8;color:#9CA3AF","Open":"background:#FFF7ED;color:#C2410C","In Progress":"background:#EFF6FF;color:#1D4ED8","Resolved":"background:#FBEAE2;color:#047857","Closed":"background:#F6F7F8;color:#9CA3AF"};
const CHIP_DOT_C={"On Time":"#ED8368","Submitted":"#ED8368","Pending":"#F59E0B","Late":"#F43F5E","Pending Approval":"#F97316","Rejected":"#9F1239","Active":"#ED8368","Inactive":"#D1D5DB","Approved":"#ED8368","Editing":"#3B82F6","Upcoming":"#A855F7","Draft":"#9CA3AF","Open":"#F97316","In Progress":"#3B82F6","Resolved":"#ED8368","Closed":"#D1D5DB"};
