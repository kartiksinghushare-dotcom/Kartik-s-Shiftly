/* ============================================================
   ...
   ============================================================ */
/* ===== STATUS CHIPS ===== */
const CHIP_STYLE={"On Time":"background:#E6F2EA;color:#1E7A50","Submitted":"background:#E6F2EA;color:#1E7A50","Pending":"background:#FFFBEB;color:#B45309","Late":"background:#FFF1F2;color:#BE123C","Pending Approval":"background:#FFF7ED;color:#C2410C","Rejected":"background:#FFF1F2;color:#9F1239","Active":"background:#E6F2EA;color:#1E7A50","Inactive":"background:#F6F7F8;color:#9CA3AF","Approved":"background:#E6F2EA;color:#1E7A50","Editing":"background:#EFF6FF;color:#1D4ED8","Upcoming":"background:#FAF5FF;color:#7E22CE","Draft":"background:#F6F7F8;color:#9CA3AF","Open":"background:#FFF7ED;color:#C2410C","In Progress":"background:#EFF6FF;color:#1D4ED8","Resolved":"background:#E6F2EA;color:#1E7A50","Closed":"background:#F6F7F8;color:#9CA3AF"};
const CHIP_DOT_C={"On Time":"#2E9E6B","Submitted":"#2E9E6B","Pending":"#F59E0B","Late":"#F43F5E","Pending Approval":"#F97316","Rejected":"#9F1239","Active":"#2E9E6B","Inactive":"#D1D5DB","Approved":"#2E9E6B","Editing":"#3B82F6","Upcoming":"#A855F7","Draft":"#9CA3AF","Open":"#F97316","In Progress":"#3B82F6","Resolved":"#2E9E6B","Closed":"#D1D5DB"};
