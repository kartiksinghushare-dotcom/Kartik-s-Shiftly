...
/* v3.20 — the chip is a CLASS, not inline styles, so it can invert inside the sender's own
   orange bubble (.crm-mine): a pale chip with dark-orange text was unreadable on #FF7F11. */
...
+'.crm-tag{background:#EDF5F7;color:#8F4A05;font-weight:700;border-radius:4px;padding:0 4px}'
